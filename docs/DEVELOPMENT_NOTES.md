...
A site review identified that the separate cloud engineering learning platform contained substantial technical evidence but was not discoverable from the main McQueen Cloud Advisory website.
...
The resource was added in three secondary locations:
...
A reusable external-link component was created:

```text
components/engagement/EngineeringKnowledgeBaseLink.tsx
```

The shared component centralizes:

- The knowledge-base URL
- External-link behavior
- `noopener noreferrer` protection
- Accessible new-tab labeling
- Button and text-link variants

### Positioning decision

The knowledge base was not added to the primary navigation.

The main site continues to prioritize the business journey:

```text
Services | Work | Assessment | Insights | About
```

The knowledge base is instead positioned as supporting evidence for visitors who want deeper technical detail.

This creates a dual-speed experience:

- Business visitors can remain focused on operating problems, outcomes, and engagement paths.
- Technical evaluators can move into deeper cloud architecture, platform, networking, security, container, serverless, and implementation content.

### About-page integration

The About page now includes a dedicated section explaining that the knowledge base documents:

- Platform concepts
- Architecture decisions
- Implementation patterns
- Hands-on labs
- Lessons from building with cloud services

The section connects continuous learning and technical depth to the founder narrative without presenting the resource as an official industry standard.

### Insights integration

The Insights page now presents the knowledge base as an extended technical companion to the shorter architecture decisions and implementation lessons published on the business site.

### Footer integration

The footer now includes a persistent text link to the knowledge base.

This improves discoverability without crowding the main navigation or interrupting the primary conversion path.
...
```text
tests/engagement/engineering-knowledge-base-discoverability.test.ts
```

The test verifies that:

- The knowledge-base URL is defined in one reusable component.
- The link opens in a new tab with the expected security attributes.
- About, Insights, and Footer reference the shared component.
- The Header does not include the knowledge-base link.
